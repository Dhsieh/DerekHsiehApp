...
public class RespondFriendRequestsAsyncTaskRunner extends AsyncTaskRunner<String, String, Boolean, List<String>> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        HttpPost post = new HttpPost("http://" + ipAddress + "/FriendRequestResponse");
        ...
        toPost.add(new BasicNameValuePair("friend", params[2]));
    ...
    protected boolean getClient(int params) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            post = new HttpPost("http://" + ipAddress + "/FriendRequestResponse");
            return true;
        } else {
            //do something
            return false;
