 ...
 */
public class GetFriendsListAsyncTaskRunner extends AsyncTaskRunner<String, String, List<String>, List<String>> {

    private Context context;
    HttpClient client;
    HttpPost post;

    public GetFriendsListAsyncTaskRunner(Context context) {
    ...
    protected List<String> doInBackground(String... params) {
        ...
        HttpPost post = new HttpPost("http://" + ipAddress + "/GetFriends");
    ...
    protected boolean getClient(int params) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            post = new HttpPost("http://" + ipAddress + "/GetFriends");
            return true;
        } else {
            //do something
            return false;
